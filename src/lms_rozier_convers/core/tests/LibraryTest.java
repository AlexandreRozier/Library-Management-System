...
public class LibraryTest {
    ...
    /**
     * Tests whether the method isContained returns true when the item belongs to the library
     * @throws Exception
     */
    @Test
    public void testIsContained() throws Exception {
        ...
        shelf1.getItemsContained().add(book);

        assertTrue(library.isContained(shelf1));
        assertTrue(library.isContained(book));
        assertFalse(library.isContained(book2));
    }
